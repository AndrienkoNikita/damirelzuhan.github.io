		...
		(modules = [
			...
			function (module, exports, __webpack_require__) {
				...
				Object.defineProperty(exports, '__esModule', { value: !0 }),
					(exports.caret = caret),
					(exports.determineLastRequiredPosition =
				...
				function trackbackPositions(originalPos, newPos, fillOnly) {
					...
					for (var ps = originalPos; ps < newPos; ps++)
						if (
							...
							!_positioning.isMask.call(this, ps, !0)
						) {
							var vp =
								0 == ps
							...
							if (void 0 !== charCode)
								if (
									...
									isTemplateMatch(initialNdx, charCodes)
										...
										: ((result =
												_eventhandlers.EventHandlers.keypressEvent.call(
													inputmask,
													keypress,
													!0,
													!1,
					...
					clickEvent: function clickEvent(e, tabbed) {
						...
						if (
							...
							var newCaretPosition =
								_positioning.determineNewCaretPosition.call(
									inputmask,
					...
					on: function on(input, eventName, eventHandler) {
						...
						;(input.inputmask.events[eventName] =
							...
							['submit', 'reset'].includes(eventName)
								? null !== input.form &&
								  $(input.form).on(eventName, ev.bind(input))
					...
					if (isValidElement(this[0]))
						for (
							...
							if (void 0 !== document && 'global' === namespace) {
								var evnt,
									i,
									params = { bubbles: !0, cancelable: !0, detail: arguments[1] }
			...
			function (module, exports, __webpack_require__) {
				...
				var _default = {
					...
					ignorables: [
						8, 9, 19, 27, 33, 34, 35, 36, 37, 38, 39, 40, 45, 46, 93, 112, 113,
